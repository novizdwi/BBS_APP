...
namespace Controllers.Transaction
{
    public partial class MaterialRequestController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvMaterialRequestList");
            if (viewModel == null)
            {
                viewModel = MaterialRequest__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            MaterialRequest__List_Model.SetBindingData(viewModel, userId, param);
