...
namespace Controllers.Transaction
{
    public partial class InventoryInController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvInventoryInList");
            if (viewModel == null)
            {
                viewModel = InventoryIn__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            InventoryIn__List_Model.SetBindingData(viewModel, userId, param);
