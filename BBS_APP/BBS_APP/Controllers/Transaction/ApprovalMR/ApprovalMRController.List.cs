...
namespace Controllers.Transaction
{
    public partial class ApprovalMRController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvApprovalMRList");
            if (viewModel == null)
            {
                viewModel = ApprovalMR__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
           ...
           ApprovalMR__List_Model.SetBindingData(viewModel, userId, param);
