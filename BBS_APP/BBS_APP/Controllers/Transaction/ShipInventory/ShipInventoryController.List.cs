...
namespace Controllers.Transaction
{
    public partial class ShipInventoryController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvShipInventoryList");
            if (viewModel == null)
            {
                viewModel = ShipInventory__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            ShipInventory__List_Model.SetBindingData(viewModel, userId, param);
