...
namespace Controllers.Transaction
{
    public partial class RunningHoursController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvRunningHoursList");
            if (viewModel == null)
            {
                viewModel = RunningHours__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            RunningHours__List_Model.SetBindingData(viewModel, userId, param);
