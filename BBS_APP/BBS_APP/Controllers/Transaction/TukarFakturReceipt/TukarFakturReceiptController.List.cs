...
namespace Controllers.Transaction
{
    public partial class TukarFakturReceiptController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvTukarFakturReceiptList");
            if (viewModel == null)
            {
                viewModel = TukarFakturReceipt__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            TukarFakturReceipt__List_Model.SetBindingData(viewModel, userId, param);
