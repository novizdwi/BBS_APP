...
namespace Controllers.Transaction
{
    public partial class InventoryReceivedController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvInventoryReceivedList");
            if (viewModel == null)
            {
                viewModel = InventoryReceived__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            InventoryReceived__List_Model.SetBindingData(viewModel, userId, param);
