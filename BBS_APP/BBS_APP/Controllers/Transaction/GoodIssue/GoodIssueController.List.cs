...
namespace Controllers.Transaction
{
    public partial class GoodIssueController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvGoodIssueList");
            if (viewModel == null)
            {
                viewModel = GoodIssue__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            GoodIssue__List_Model.SetBindingData(viewModel, userId, param);
