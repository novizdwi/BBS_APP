...
namespace Controllers.Transaction
{
    public partial class FuelControlController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvSFuelControlList");
            if (viewModel == null)
            {
                viewModel = FuelControl__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            FuelControl__List_Model.SetBindingData(viewModel, userId, param);
