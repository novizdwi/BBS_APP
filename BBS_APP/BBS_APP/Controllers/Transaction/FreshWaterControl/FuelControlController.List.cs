...
namespace Controllers.Transaction
{
    public partial class FreshWaterControlController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvSFreshWaterControlList");
            if (viewModel == null)
            {
                viewModel = FreshWaterControl__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            FreshWaterControl__List_Model.SetBindingData(viewModel, userId, param);
