...
namespace Controllers.Transaction
{
    public partial class InventorySendController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvInventorySendList");
            if (viewModel == null)
            {
                viewModel = InventorySend__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            InventorySend__List_Model.SetBindingData(viewModel, userId, param);
