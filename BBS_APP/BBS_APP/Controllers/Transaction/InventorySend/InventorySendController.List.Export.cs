...
namespace Controllers.Transaction
{
    public partial class InventorySendController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<View___> items = null;//= InventorySend__List_Model.GetDataList(userId, param, hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
        ...
        public partial class GridViewExportHelper
        {
            ...
            static GridViewSettings CreateExportGridViewSettings()
            {
                ...
                GridViewSettings settings = InventorySend__List_Model.CreateExportGridViewSettings();
