...
namespace Controllers.Transaction
{
    public partial class CleaningTankController : BaseController
    {
        ...
        public ActionResult Attachment_Upload()
        {
            ...
            var UploadMultiFile = UploadControlExtension.GetUploadedFiles("UploadMultiFile", CleaningTankUploadControlHelper.ValidationSettings, CleaningTankUploadControlHelper.FileUploadComplete);
            ...
            if (UploadMultiFile != null)
            {
                ...
                List<CleaningTank_AttachmentModel> listModel = new List<CleaningTank_AttachmentModel>();
               ...
               cleaningTankService.Attachment_Add(listModel);

                for (int i = 0; i < listModel.Count; i++)
                {
                    string strFilename =CleaningTankUploadControlHelper.GetFilePath(listModel[i].Guid + "_" + listModel[i].FileName);
        ...
        public FileResult Attachment_Download(int DetId = 0)
        {
            ...
            using (var CONTEXT = new BBS_DI.Models._EF.HANA_APP())
            {
                ...
                if (model != null)
                {
                    ...
                    return File(CleaningTankUploadControlHelper.GetFilePath(model.Guid + "_" + model.FileName), System.Net.Mime.MediaTypeNames.Application.Octet, fileName);
                }
                return null;
            }
    ...
    public class CleaningTankUploadControlHelper
    {
        public const string UploadDirectory = "~/Content/Attachment/CleaningTank/";
