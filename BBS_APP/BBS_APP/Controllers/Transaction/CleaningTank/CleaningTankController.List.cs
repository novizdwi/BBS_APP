...
namespace Controllers.Transaction
{
    public partial class CleaningTankController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvSCleaningTankList");
            if (viewModel == null)
            {
                viewModel = CleaningTank__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            CleaningTank__List_Model.SetBindingData(viewModel, userId, param);
