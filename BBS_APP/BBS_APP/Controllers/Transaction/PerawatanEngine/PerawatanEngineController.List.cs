...
namespace Controllers.Transaction
{
    public partial class PerawatanEngineController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvSPerawatanEngineList");
            if (viewModel == null)
            {
                viewModel = PerawatanEngine__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            PerawatanEngine__List_Model.SetBindingData(viewModel, userId, param);
