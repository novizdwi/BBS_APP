...
namespace Controllers.Transaction
{
    public partial class PerawatanEngineController : BaseController
    {
        ...
        public ActionResult Attachment_Upload()
        {
            ...
            var UploadMultiFile = UploadControlExtension.GetUploadedFiles("UploadMultiFile", PerawatanEngineUploadControlHelper.ValidationSettings, PerawatanEngineUploadControlHelper.FileUploadComplete);
            ...
            if (UploadMultiFile != null)
            {
                ...
                List<PerawatanEngine_AttachmentModel> listModel = new List<PerawatanEngine_AttachmentModel>();
               ...
               perawatanEngineService.Attachment_Add(listModel);

                for (int i = 0; i < listModel.Count; i++)
                {
                    string strFilename =PerawatanEngineUploadControlHelper.GetFilePath(listModel[i].Guid + "_" + listModel[i].FileName);
        ...
        public FileResult Attachment_Download(int DetId = 0)
        {
            ...
            using (var CONTEXT = new BBS_DI.Models._EF.HANA_APP())
            {
                ...
                if (model != null)
                {
                    ...
                    return File(PerawatanEngineUploadControlHelper.GetFilePath(model.Guid + "_" + model.FileName), System.Net.Mime.MediaTypeNames.Application.Octet, fileName);
                }
                return null;
            }
    ...
    public class PerawatanEngineUploadControlHelper
    {
        public const string UploadDirectory = "~/Content/Attachment/PerawatanEngine/";
