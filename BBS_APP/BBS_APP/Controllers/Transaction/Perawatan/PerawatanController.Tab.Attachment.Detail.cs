...
namespace Controllers.Transaction
{
    public partial class PerawatanController : BaseController
    {
        ...
        public ActionResult Attachment_Upload()
        {
            ...
            var UploadMultiFile = UploadControlExtension.GetUploadedFiles("UploadMultiFile", PerawatanUploadControlHelper.ValidationSettings, PerawatanUploadControlHelper.FileUploadComplete);
            ...
            if (UploadMultiFile != null)
            {
                ...
                List<Perawatan_AttachmentModel> listModel = new List<Perawatan_AttachmentModel>();
               ...
               perawatanService.Attachment_Add(listModel);

                for (int i = 0; i < listModel.Count; i++)
                {
                    string strFilename =PerawatanUploadControlHelper.GetFilePath(listModel[i].Guid + "_" + listModel[i].FileName);
        ...
        public FileResult Attachment_Download(int DetId = 0)
        {
            ...
            using (var CONTEXT = new BBS_DI.Models._EF.HANA_APP())
            {
                ...
                if (model != null)
                {
                    ...
                    return File(PerawatanUploadControlHelper.GetFilePath(model.Guid + "_" + model.FileName), System.Net.Mime.MediaTypeNames.Application.Octet, fileName);
                }
                return null;
            }
    ...
    public class PerawatanUploadControlHelper
    {
        public const string UploadDirectory = "~/Content/Attachment/Perawatan/";
