...
namespace Controllers.Transaction
{
    public partial class PerawatanController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvSPerawatanList");
            if (viewModel == null)
            {
                viewModel = Perawatan__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            Perawatan__List_Model.SetBindingData(viewModel, userId, param);
