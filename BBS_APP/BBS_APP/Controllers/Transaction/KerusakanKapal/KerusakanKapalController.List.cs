...
namespace Controllers.Transaction
{
    public partial class KerusakanKapalController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvSKerusakanKapalList");
            if (viewModel == null)
            {
                viewModel = KerusakanKapal__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            KerusakanKapal__List_Model.SetBindingData(viewModel, userId, param);
