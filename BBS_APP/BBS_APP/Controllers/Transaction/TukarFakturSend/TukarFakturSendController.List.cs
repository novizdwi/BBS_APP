...
namespace Controllers.Transaction
{
    public partial class TukarFakturSendController : BaseController
    {
        ...
        {
            var viewModel = GridViewExtension.GetViewModel("gvTukarFakturSendList");
            if (viewModel == null)
            {
                viewModel = TukarFakturSend__List_Model.CreateGridViewModel();
            }
        ...
        static void ProcessCustomBinding(int userId, GridViewModel viewModel, ListFindParam param)
        {
            ...
            TukarFakturSend__List_Model.SetBindingData(viewModel, userId, param);
