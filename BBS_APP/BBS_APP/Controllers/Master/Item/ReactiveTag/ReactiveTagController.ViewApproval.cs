...
namespace Controllers.Master.Item
{
    public partial class ReactiveTagController : BaseController
    {
        ...
        public ActionResult ViewApproval_PopupListOnDemandPartial(long Id = 0)
        {
            ...
            if (Id != 0)
            {
                model = reactiveTagService.GetViewApproval(Id);
            }
        ...
        public ActionResult ViewApprovalListPartial()
        {
            ...
            List<ReactiveTag_ApprovalModel> modelList = reactiveTagService.GetReactiveTag_ApprovalSteps(Id);
        ...
        {
            int userId = (int)Session["userId"];
            var model = new ReactiveTagApprovalView___();
