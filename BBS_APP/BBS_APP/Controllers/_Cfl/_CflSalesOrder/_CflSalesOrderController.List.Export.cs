...
namespace Controllers._Cfl
{
    public partial class _CflSalesOrderController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflSalesOrder_View__> items = null;//= CflSalesOrder_Model.GetDataList(userId, cflSalesOrderParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflSalesOrderParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflSalesOrder_ParamModel cflSalesOrderParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflSalesOrderParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflSalesOrder_ParamModel cflSalesOrderParam)
            {

                GridViewSettings settings = CflSalesOrder_Model.CreateExportGridViewSettings(cflSalesOrderParam);
