...
namespace Controllers._Cfl
{
    public partial class _CflSppHistoryController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflSppHistory_View__> items = CflSppHistory_Model.GetDataList(userId, cflSppHistoryParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflSppHistoryParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflSppHistory_ParamModel cflSppHistoryParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflSppHistoryParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflSppHistory_ParamModel cflSppHistoryParam)
            {

                GridViewSettings settings = CflSppHistory_Model.CreateExportGridViewSettings(cflSppHistoryParam);
