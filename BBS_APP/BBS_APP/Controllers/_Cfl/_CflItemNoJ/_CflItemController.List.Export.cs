...
namespace Controllers._Cfl
{
    public partial class _CflItemNoJController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflItemNoJ_View__> items = CflItemNoJ_Model.GetDataList(userId, cflItemNoJParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflItemNoJParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflItemNoJ_ParamModel cflItemNoJParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflItemNoJParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflItemNoJ_ParamModel cflItemNoJParam)
            {

                GridViewSettings settings = CflItemNoJ_Model.CreateExportGridViewSettings(cflItemNoJParam);
