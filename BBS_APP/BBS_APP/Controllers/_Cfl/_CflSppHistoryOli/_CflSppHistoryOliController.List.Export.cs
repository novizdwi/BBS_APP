...
namespace Controllers._Cfl
{
    public partial class _CflSppHistoryOliController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflSppHistoryOli_View__> items = CflSppHistoryOli_Model.GetDataList(userId, cflSppHistoryOliParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflSppHistoryOliParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflSppHistoryOli_ParamModel cflSppHistoryOliParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflSppHistoryOliParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflSppHistoryOli_ParamModel cflSppHistoryOliParam)
            {

                GridViewSettings settings = CflSppHistoryOli_Model.CreateExportGridViewSettings(cflSppHistoryOliParam);
