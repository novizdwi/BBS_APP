...
namespace Controllers._Cfl
{
    public partial class _CflNoTtdController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflNoTtd_View__> items = null;//= CflNoTtd_Model.GetDataList(userId, cflNoTtdParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflNoTtdParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflNoTtd_ParamModel cflNoTtdParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflNoTtdParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflNoTtd_ParamModel cflNoTtdParam)
            {

                GridViewSettings settings = CflNoTtd_Model.CreateExportGridViewSettings(cflNoTtdParam);
