...
namespace Controllers._Cfl
{
    public partial class _CflMaterialRequestController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflMaterialRequest_View__> items = CflMaterialRequest_Model.GetDataList(userId, cflMaterialRequestParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflMaterialRequestParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflMaterialRequest_ParamModel cflMaterialRequestParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflMaterialRequestParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflMaterialRequest_ParamModel cflMaterialRequestParam)
            {

                GridViewSettings settings = CflMaterialRequest_Model.CreateExportGridViewSettings(cflMaterialRequestParam);
