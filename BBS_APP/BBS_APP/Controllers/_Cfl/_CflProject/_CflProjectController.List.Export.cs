...
namespace Controllers._Cfl
{
    public partial class _CflProjectController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflProject_View__> items = CflProject_Model.GetDataList(userId, cflProjectParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflProjectParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflProject_ParamModel cflProjectParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflProjectParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflProject_ParamModel cflProjectParam)
            {

                GridViewSettings settings = CflProject_Model.CreateExportGridViewSettings(cflProjectParam);
