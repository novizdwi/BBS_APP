...
namespace Controllers._Cfl
{
    public partial class _CflShipROBController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflShipROB_View__> items = CflShipROB_Model.GetDataList(userId, CflShipROBParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(CflShipROBParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflShipROB_ParamModel CflShipROBParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(CflShipROBParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflShipROB_ParamModel CflShipROBParam)
            {

                GridViewSettings settings = CflShipROB_Model.CreateExportGridViewSettings(CflShipROBParam);
