...
namespace Controllers._Cfl
{
    public partial class _CflNamaCustomerController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<CflNamaCustomer_View__> items = null;//= CflNamaCustomer_Model.GetDataList(userId, cflNamaCustomerParam, filterExpression, sortExpression, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize));
            return GridViewExportHelper.ExportTypes["XLS"].Method(GridViewExportHelper.ExportGridViewSettings(cflNamaCustomerParam), items);
        ...
        public partial class GridViewExportHelper
        {
            ...
            public static GridViewSettings ExportGridViewSettings(CflNamaCustomer_ParamModel cflNamaCustomerParam)
            {
                //get
                //{
                if (exportGridViewSettings == null)
                    exportGridViewSettings = CreateExportGridViewSettings(cflNamaCustomerParam);
                return exportGridViewSettings;
                //}
            }
            static GridViewSettings CreateExportGridViewSettings(CflNamaCustomer_ParamModel cflNamaCustomerParam)
            {

                GridViewSettings settings = CflNamaCustomer_Model.CreateExportGridViewSettings(cflNamaCustomerParam);
