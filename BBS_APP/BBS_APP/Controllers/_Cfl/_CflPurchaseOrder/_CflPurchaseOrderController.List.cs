...
namespace Controllers._Cfl
{
    public partial class _CflPurchaseOrderController : BaseController
    {
        ...
        public ActionResult ListPartial()
        {
            ...
            ProcessCustomPurchaseOrderding(userId, cflPurchaseOrderParam, viewModel);
        ...
        static void ProcessCustomPurchaseOrderding(int userId, CflPurchaseOrder_ParamModel cflParam, GridViewModel viewModel)
        {
            CflPurchaseOrder_Model.SetBindingData(viewModel, userId, cflParam);
