...
namespace Models.Master.DocContent
{
    ...
    public class View___
    {
        ...
        public string ExpiredName { get; set; }

        public Int32? WarningNotif { get; set; }
    ...
    public class DocContent__List_Model
    {
        static string ViewSql = "SELECT T0.*, T1.\"Name\" \"TypeName\", T2.\"Name\" \"ExpiredName\" FROM \"Tm_DocContent\" T0 " +
                                "LEFT JOIN \"Ts_List\" T1 ON T1.\"Type\" ='DocContent_Type' AND T0.\"Type\" = T1.\"Code\"  " +
                                "LEFT JOIN \"Ts_List\" T2 ON T2.\"Type\" ='DocContent_ExpiredType' AND T0.\"ExpiredType\" = T2.\"Code\"  ";
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Columns.Add("ShipName", "ShipName");
