...
namespace Models.Transaction.Receipt
{
    ...
    public class Receipt__List_Model
    {
        static string ViewSql = "SELECT T0.* FROM \"Tx_Receipt\" T0 ";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "Receipt", "Tx_Receipt___");
