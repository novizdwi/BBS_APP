...
namespace Models.Transaction.ApprovalMR
{
    ...
    public class ApprovalMR__List_Model
    {
        static string ViewSql = "SELECT T0.\"Id\" AS \"Id\"," +
                                ...
                                "T0.\"SapDocNum\" AS \"SapDocNum\"," +
                                "T0.\"Status\" AS \"Status\"" +
                                "FROM \"Tx_ApprovalMR\" T0 " +
                                "LEFT JOIN \"Ts_List\" T1 ON T0.\"ReqType\" = T1.\"Code\" AND T1.\"Type\" = \'ApprovalMRStatus\'ORDER BY T0.\"TransDate\" DESC";
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List Approval MR";
            ...
            settings.Columns.Add("TransNo", "No");
