...
namespace Models.Transaction.InventorySend
{
    ...
    public class InventorySend__List_Model
    {
        static string ViewSql = @"SELECT DISTINCT A.""Id"",
                                                    ...
                                                    A.""SapDocNum"",
                                                    A.""Received""
                                FROM ""Tx_InventorySend"" A
                                LEFT JOIN ""Tx_InventorySend_Detail"" A1 ON A.""Id"" = A1.""Id""
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "InventorySend", "Tx_InventorySend___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Columns.Add("TransNo", "InventorySend No");
            settings.Columns.Add("TransDate", "InventorySend Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
