...
namespace Models.Transaction.Overhaul
{
    ...
    public class Overhaul__List_Model
    {
        ...
        public static void SetBindingData(GridViewModel state, int userId, ListFindParam cflParam)
        {
            ...
            {
                var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(CONTEXT, userId, "Overhaul");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Columns.Add("ShipName", "Nama Kapal");
            settings.Columns.Add("StartDate", "Start Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
            
            settings.Columns.Add("Overhaul", "Overhaul");
            settings.Columns.Add("Status", "Status");
            settings.Columns.Add("EndDate", "End Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
            settings.Columns.Add("TransDate", "Tgl. Dokumen", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
