...
namespace Models.Transaction.AdjustmentOut
{
    ...
    {
        static string ViewSql = "SELECT * FROM \"Tx_AdjustmentOut\" ";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "AdjustmentOut", "Tx_AdjustmentOut___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List AdjustmentOut";

            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id").Visible = false;
            settings.Columns.Add("TransNo", "AdjustmentOut No");
            settings.Columns.Add("TransDate", "AdjustmentOut Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
