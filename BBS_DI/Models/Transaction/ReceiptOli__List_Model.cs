...
namespace Models.Transaction.ReceiptOli
{
    ...
    public class ReceiptOli__List_Model
    {
        static string ViewSql = "SELECT T0.* FROM \"Tx_ReceiptOli\" T0 ";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "ReceiptOli", "Tx_ReceiptOli___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List ReceiptOli DO";
