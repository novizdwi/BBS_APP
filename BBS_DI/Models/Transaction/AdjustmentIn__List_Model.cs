...
namespace Models.Transaction.AdjustmentIn
{
    ...
    {
        static string ViewSql = "SELECT * FROM \"Tx_AdjustmentIn\" ";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "AdjustmentIn", "Tx_AdjustmentIn___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List AdjustmentIn";

            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id").Visible = false;
            settings.Columns.Add("TransNo", "AdjustmentIn No");
            settings.Columns.Add("TransDate", "AdjustmentIn Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
