...
namespace Models.Transaction.InventoryIn
{
    ...
    public class InventoryIn__List_Model
    {
        static string ViewSql = @"SELECT DISTINCT A.""Id"",
		                                            ...
		                                            A.""VendorName"",
		                                            A1.""ShipName"",
		                                            C.""BaseTransNo"" AS ""MRNum""
                                FROM ""Tx_InventoryIn"" A
                                LEFT JOIN ""Tx_InventoryIn_Detail"" A1 ON A.""Id"" = A1.""Id""
                                LEFT JOIN MJL_TEST.""OPOR"" B ON B.""DocEntry"" = A.""SapPoId""
                                LEFT JOIN ""Tx_ApprovalMR"" C ON B.""U_IDU_WebTransId"" = C.""Id""";
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Columns.Add("TransNo", "InventoryIn No");
            settings.Columns.Add("TransDate", "InventoryIn Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
