...
namespace Models.Transaction.InventoryReceived
{
    ...
    public class InventoryReceived__List_Model
    {
        static string ViewSql = @"SELECT DISTINCT A.""Id"",
		                                            A.""TransNo"",
		                                            A.""TransDate"",
		                                            A.""FromWarehouseCode"",
		                                            A.""ToWarehouseCode"",
		                                            A.""Status"",
		                                            A.""SapDocNum""
                                FROM ""Tx_InventoryReceived"" A
                                LEFT JOIN ""Tx_InventoryReceived_Detail"" A1 ON A.""Id"" = A1.""Id""
                                LEFT JOIN MJL_TEST.""OWTR"" B ON B.""DocEntry"" = A.""SapDocEntry"" ORDER BY A.""TransDate"" DESC";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "InventoryReceived", "Tx_InventoryReceived___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List InventoryReceived";

            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id").Visible = false;
            settings.Columns.Add("TransNo", "InventoryReceived No");
            settings.Columns.Add("TransDate", "InventoryReceived Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
