...
namespace Models.Transaction.Web.Inventory
{
    ...
    public class TransferSummaryOutService
    {
        ...
        public void PostSAP(int userId, long id)
        {
            ...
            TransferSummaryOutModel syncGRPO = GetById(userId, id);
            using (var CONTEXT = new HANA_APP())
            {
                ...
                using (var CONTEXT_TRANS = CONTEXT.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (tx_TransferSummaryOut != null)
                        {
                            GRPOAddResultModel GRPOResult = AddTransferSummaryOut(oCompany, userId, id, syncGRPO);
                            ...
                            tx_TransferSummaryOut.DocEntry = Convert.ToInt64(GRPOResult.DocEntry) ;
        ...
        private GRPOAddResultModel AddTransferSummaryOut(Company oCompany, int userId, long id, TransferSummaryOutModel model)
        {
