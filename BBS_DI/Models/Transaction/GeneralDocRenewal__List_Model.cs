...
namespace Models.Transaction.GeneralDocRenewal
{
    ...
    public class View___
    {
        ...
        public string DocumentName_ { get; set; }
    ...
    public class GeneralDocRenewal__List_Model
    {
        static string ViewSql = "SELECT T0.*, T1.\"DocumentName\" AS \"DocumentName_\" FROM \"Tx_GeneralDocRenewal\" T0 " +
                                "LEFT JOIN \"Tm_DocGeneral\" T1 ON T0.\"DocumentId\" = T1.\"Id\" ";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "GeneralDocRenewal", "Tx_GeneralDocRenewal___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List Document Renewal";

            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id").Visible = false;
            settings.Columns.Add("TransNo", "Work Order No");
            settings.Columns.Add("TransDate", "WO Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
