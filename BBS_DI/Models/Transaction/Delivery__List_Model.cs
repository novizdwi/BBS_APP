...
namespace Models.Transaction.Delivery
{
    ...
    public class Delivery__List_Model
    {
        static string ViewSql = "SELECT * FROM \"Tx_Delivery\" ";
        ...
        {
            //var formAuthorizeSqlWhere = GeneralGetList.GetFormTransAuthorizeSqlWhere(userId, "Delivery", "Tx_Delivery___");
        ...
        public static GridViewSettings CreateExportGridViewSettings()
        {
            ...
            settings.Name = "List Delivery";

            settings.KeyFieldName = "Id";
            settings.Columns.Add("Id").Visible = false;
            settings.Columns.Add("TransNo", "Delivery No");
            settings.Columns.Add("TransDate", "Delivery Date", MVCxGridViewColumnType.DateEdit).PropertiesEdit.DisplayFormatString = "dd/MM/yyyy";
